...
parser.add_argument('--use_cuda', default=False, type = bool, help='use cuda or not')
parser.add_argument('--use_cudnn',default=0,type=int, help = 'use cudnn or not')
parser.add_argument('--dtype', default=torch.FloatTensor, choices = [torch.cuda.FloatTensor,torch.FloatTensor],help = 'tensor data type ')
